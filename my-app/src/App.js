...
class App extends Component {
  ...
  state = {
    ...
    currentScore: 0,
    maxScore: 0,
    navNote: "Click on a Animals to begin!"
  };
  ...
  updateState = id => {
    ...
    if(Image.clicked === false) {
      ...
      this.Shuffle(images);
      this.setState({ images });
      this.setState({ navNote: "Nice! Continue choosing a different Animals!" });
      ...
      this.gameWon(this.state.currentScore);
        ...
        this.setState({ images });
        this.setState({ navNote: "OH NO! You clicked on that Animal already!" });
        this.setState({ currentScore: 0});
    };
